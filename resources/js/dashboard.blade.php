...
sleep(300).then(() => {
    ...
    if(document.getElementById("trafficLight5"))
    {
        ...
        jQuery.getJSON('/getDashboardSettings/' + t5Settings, function (t5Details) {
            jQuery.getJSON('/identifySensor/' + t5Details.map + " " + t5Details.zone + " : " + t5Details.sensor + '/' + encodeURI(t5Details.readingType), function (t5List) {
...
function urlDashboard($content)
{
    ...
    $content .= "<div class=\"panel panel-primary\" id=\"urlDashboard\" style=\"width: 100%; height: 100%;\">";
        $content .= "<div class=\"panel-heading\">";
            ...
            $content .= "<i class=\"fa fa-edit pull-right\" style=\"cursor: pointer;\" id=\"delItem\"></i>";
        $content .= "</div>";
